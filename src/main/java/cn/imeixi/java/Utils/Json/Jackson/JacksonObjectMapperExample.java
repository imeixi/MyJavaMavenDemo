package cn.imeixi.java.Utils.Json.Jackson;
...
import cn.imeixi.java.Utils.Json.model.Address;
import cn.imeixi.java.Utils.Json.model.Employee;
...
public class JacksonObjectMapperExample {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(Paths.get("employee.txt"));
		...
		String str = objectMapper.writeValueAsString(emp1);
